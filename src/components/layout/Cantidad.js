...
const Cantidad = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center h-24 round bg-gray-800">
        <p className="text-2xl text-gray- text-gray-500">Usuarios</p>
        <p className="text-gray-400 text- p-2">{totalUsuarios}</p>
      </div>
      <div className="flex flex-col items-center justify-center h-24 round bg-gray-800">
        <p className="text-2xl  text-gray-500">Grupos</p>
        <p className="text-gray-400 p-2">{totalGrupos}</p>
      </div>
      <div className="flex flex-col items-center justify-center h-24 round bg-gray-800">
        <p className="text-2xl  text-gray-500">Eventos</p>
        <p className="text-gray-400 p-2">{totalEventos}</p>
      </div>
      <div className="flex flex-col items-center justify-center h-24 round bg-gray-800">
        <p className="text-2xl  text-gray-500">Noticias</p>
        <p className="text-gray-400 p-2">{totalNotices}</p>
      </div>
      <div className="flex flex-col items-center justify-center h-24 round bg-gray-800">
        <p className="text-2xl  text-gray-500">Categorias</p>
