      ...
      <div className="px-0 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-0 lg:px-8">
          ...
          <div>
            ...
            <section>
              <div className="grid pt-4 grid-cols-2 gap-4 lg:grid-cols-4 align-center text-center">
                ...
                <a
                  href="https://www.instagram.com/oficialtecnl/?hl=es"
                  target="_blank"
                  rel="noreferrer"
                  className="text-indigo-600 font-semibold text-center transition-colors duration-300 "
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
            ...
            <p className="mt-4 text-white text-sm">
              Si tienes alguna duda o sugerencia, contáctanos a través de
        ...
        <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
          <p className="text-sm text-white">
            © {new Date().getFullYear()} Instituto Tecnológico de Nuevo León.
