          ...
          <div className="mx-auto py-36 sm:py-42 lg:py-16">
            <div className="">
              ...
              <div className="flex items-center mt-4 text-white text-lg">
                ...
                {evento && evento.user && (
                  <p className="leading-8">{`Organizado por ${evento.user.department}`}</p>
                )}
              </div>
              <div className="flex items-center mt-4 text-white text-lg">
                <svg
              ...
              <button
                className="bg-blue-700 mt-4 active:bg-blue-900 hover:bg-blue-900 uppercase text-white font-bold  text-xs px-4 py-2 rounded"
                type="button"
...
export default EventoPaginaUsuario;
